...
const routes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
            ...
            },
            {
                path: "/applicants",
                name: "applicants",
                component: () => import("@/views/applicant/Applicants.vue"),
                meta: {
                ...
                children: [
                    {
                        ...
                        name: "view-applicant",
                        props: true,
                        component: () => import("@/views/applicant/ViewApplicant.vue"),
                    },
                    {
                        path: "demands",
                        name: "applicant-demands",
                        props: true,
                        component: () => import("@/views/applicant/ApplicantDemands.vue"),
                    },
                ]
            },
            {
                ...
                name: "user-users",
                component: () => import("@/views/user_managements/Users.vue"),
                meta: {
                    pageTitle: "users",
                    breadcrumbs: ["users"],
                },
            },
            {
                ...
                name: "view-user",
                component: () => import("@/views/user_managements/User.vue"),
                props: true,
                meta: {
                    pageTitle: "user",
                    breadcrumbs: ["user"],
                ...
                children: [
                    {
                        ...
                        props: true,
                        component: () => import("@/views/user_managements/UserApplicants.vue"),
                    },

                    {
                        ...
                        name: "user-setting",
                        props: true,
                        component: () => import("@/views/user_managements/UserSetting.vue"),
                    }
                ]
            },
            {
                ...
                name: "user-roles",
                component: () => import("@/views/user_managements/Roles.vue"),
                meta: {
                    pageTitle: "roles",
                    breadcrumbs: ["roles"],
                },
            ...
            {
                path: "/user-management/role/:roleId/:roleName",
                name: "user-role",
                component: () => import("@/views/user_managements/Role.vue"),
                props: true,
                meta: {
                    pageTitle: "role",
                    breadcrumbs: ["role"],
            ...
            },
            {
                ...
                component: () => import("@/views/user_managements/Permissions.vue"),
                meta: {
            ...
            },
            {
                path: "/site-variables",
                name: "site-variables",
                component: () => import("@/views/site_variables/SiteVariables.vue"),
                meta: {
...
router.beforeEach((to, from, next) => {
    ...
    const isGoingToAuthPages = to.matched.some(item => item.meta.authLess)
    const goingToSignIn = () => to.name === "sign-in";

    goingToSignIn() && loggedIn && next('/dashboard')

    isGoingToAuthPages || loggedIn ? next() : next('/sign-in')
