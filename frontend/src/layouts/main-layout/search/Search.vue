    ...
    <template v-slot:content>
      ...
      >
        ...
        <form v-if="state === 'advanced-options'" class="pt-1">
          <!--begin::Heading-->
          <h3 class="fw-semobold text-dark mb-7">جستجوی پیشرفته</h3>
          <!--end::Heading-->
          ...
          <div class="mb-5">
            ...
            >
              <option value="next">اولی</option>
              <option value="last">آخری</option>
              <option value="between">بین</option>
              <option value="on">هنگام</option>
            </select>
          </div>
          <!--end::Input group-->
          ...
          <div class="d-flex justify-content-end">
            ...
            <a href="#" class="btn btn-sm fw-bold btn-primary">جستجو</a>
          </div>
          <!--end::Actions-->
        </form>
        ...
        <form v-if="state === 'preferences'" class="pt-1">
          <!--begin::Heading-->
          <h3 class="fw-semobold text-dark mb-7">تنظیمات جستجو</h3>
          <!--end::Heading-->
          ...
          <div class="d-flex justify-content-end pt-7">
            ...
            <button class="btn btn-sm fw-bold btn-primary">ذخیره تغییرات</button>
          </div>
          <!--end::Actions-->
        </form>
      </div>
